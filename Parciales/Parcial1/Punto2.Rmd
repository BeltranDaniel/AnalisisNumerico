...
Observando los datos anteriores se obtuvieron resultados similares en ambos algoritmos. A partir de lo cual se puede suponer que la convergencia del algoritmo A es de orden cuadrática, no obstante el método de Newton es más rapido, ya que el Algoritmo A si se ejecuta varias veces puede resultar en resultados ligeramente distintos debido a que es un algoritmo inestable.
